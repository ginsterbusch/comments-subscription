...
*/
  ...
  class sg_subscribe {
      ...
      var $mail_text;
      var $mail_text_head;
      var $known_keywords = array(
		'comment_id', 'post_id', 'post_permalink', 'home_url', 'site_url',
      );
...
<?php
    ...
    /**
     * Replaces all known keywords inside the custom comment URL template.
     * 
     * @author Fabian Wolf (@link http://usability-idealist.de/)
     * 
     * @param string $url	URL to find and replace keywords in.
     * @param array $data	An array consisting of the current post and comment data (array( 'post' => post, 'comment' => 'comment').
     * @return string $url	Returns the parsed URL (if there were any known keywords to replace).
     * 
     * [comment_id], [post_id], [post_permalink], [home_url], [site_url]
     */
